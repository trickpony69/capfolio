...
function NextProject(props) {
    ...
    const onClickHandler = () => {
        // mobile
        document.getElementsByClassName("p-6 leading-[5.5rem]")[0].scrollIntoView({ behavior: "smooth" });
        // desktop
        document.getElementsByClassName("p-6 leading-[5.5rem]")[1].scrollIntoView({ behavior: "smooth" });
    }
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex justify-between py-10">
                <a className="block w-3/6 pt-4 rounded-full text-3xl font-thunder-medium bg-cap-acid text-center" href="mailto:andrea.cappellari15@gmail.com" target="_blank">EMAIL ME</a>
